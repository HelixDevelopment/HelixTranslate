...
**Revision:** 11
**Last modified:** 2026-06-16T13:20:00Z
...
| Video-confirmed | 35 (Wave 3b added 3 net-new: Gemini + Zhipu (GLM) + Cohere library clients, distinct real EN→SR-latin translations; Wave 3a added 2: Cerebras + SambaNova per-provider LLM clients; Wave 2 added 5: DOCX output, PDF output, HTML→Markdown conversion, ProviderDiverseTranslators, EnsembleFactory) |
