...
**Revision:** 9
**Last modified:** 2026-06-16T12:00:00Z
...
- **New this round (Wave 2):** **DOCX output**, **PDF output**, **HTML→Markdown conversion**, and the **provider-diverse translators** (`ProviderDiverseTranslators` + `EnsembleFactory`) are all now video-proven — and the gRPC server translation was re-confirmed with an additional clip. The Wave-1 default-translation-path blocker is resolved.
...
**30 / 494 ≈ 6.1%** (Wave 2 added 5 net-new video confirmations: DOCX output, PDF output, HTML→Markdown conversion, ProviderDiverseTranslators, EnsembleFactory; DOCX + PDF are no longer real-artifact-only — they are now video-confirmed). This is the headline number to keep improving: each new genuine recording raises it.
...
| Video-confirmed | 30 (Wave 2 added 5 net-new: DOCX output, PDF output, HTML→Markdown conversion, ProviderDiverseTranslators, EnsembleFactory; DOCX + PDF now video-confirmed, no longer real-artifact-only) |
